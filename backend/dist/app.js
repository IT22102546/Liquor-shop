...
const bike_management_routes_1 = __importDefault(require("./modules/bike-management/bike-management.routes"));
const pos_user_management_routes_1 = __importDefault(require("./modules/pos-user-management/pos-user-management.routes"));
const pre_orders_routes_1 = __importStar(require("./modules/pre-orders/pre-orders.routes"));
...
app.use("/api/pre-orders", pre_orders_routes_1.publicPreOrdersRouter);
app.use("/api/pos/auth", pos_auth_routes_1.default);
app.use("/api/pos/bike-management", bike_management_routes_1.default);
app.use("/api/pos/user-management", pos_user_management_routes_1.default);
app.use("/api/pos/pre-orders", pre_orders_routes_1.default);
